...
class ShowtimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create showtime" do
    assert_difference('Showtime.count') do
      post showtimes_url, params: { showtime: { cinema_id: @showtime.cinema_id, date: @showtime.date, movie_id: @showtime.movie_id } }
    end
  ...
  test "should update showtime" do
    patch showtime_url(@showtime), params: { showtime: { cinema_id: @showtime.cinema_id, date: @showtime.date, movie_id: @showtime.movie_id } }
