...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { seat: @seat.seat, showtimes_id: @seat.showtimes_id, user_id: @seat.user_id } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { seat: @seat.seat, showtimes_id: @seat.showtimes_id, user_id: @seat.user_id } }
